...
def create_agent_tools(agent) -> list[FunctionTool]:
    """
    Create function tools for HufAI Agent
    """
    tools = []
            ...
            try:
                ...
                if function_doc.types in ["Custom Function", "App Provided"]:
                    ...
                    if function_doc.types == "Get List":
                        function_path = "hufai.ai.sdk_tools.handle_get_list"
                    elif function_doc.types == "Get Document":
                        function_path = "hufai.ai.sdk_tools.handle_get_document"
                    elif function_doc.types == "Update Document":
                        function_path = "hufai.ai.sdk_tools.handle_update_document"
                    elif function_doc.types == "Create Document":
                        function_path = "hufai.ai.sdk_tools.handle_create_document"
                    elif function_doc.types == "Delete Document":
                        function_path = "hufai.ai.sdk_tools.handle_delete_document"
                    elif function_doc.types == "Get Multiple Documents":
                        function_path = "hufai.ai.sdk_tools.handle_get_documents"
                    elif function_doc.types == "Create Multiple Documents":
                        function_path = "hufai.ai.sdk_tools.handle_create_documents"
                    elif function_doc.types == "Update Multiple Documents":
                        function_path = "hufai.ai.sdk_tools.handle_update_documents"
                    elif function_doc.types == "Delete Multiple Documents":
                        function_path = "hufai.ai.sdk_tools.handle_delete_documents"
                    elif function_doc.types == "Submit Document":
                        function_path = "hufai.ai.sdk_tools.handle_submit_document"
                    elif function_doc.types == "Cancel Document":
                        function_path = "hufai.ai.sdk_tools.handle_cancel_document"
                    elif function_doc.types == "Get Value":
                        function_path = "hufai.ai.sdk_tools.handle_get_value"
                    elif function_doc.types == "Set Value":
                        function_path = "hufai.ai.sdk_tools.handle_set_value"
                    elif function_doc.types == "Get Report Result":
                        function_path = "hufai.ai.sdk_tools.handle_get_report_result"
                    elif function_doc.types == "GET":
                        function_path = "hufai.ai.http_handler.handle_get_request"
                    elif function_doc.types == "POST":
                        function_path = "hufai.ai.http_handler.handle_post_request"
                    elif function_doc.types == "Run Agent":
                        function_path = "hufai.ai.sdk_tools.handle_run_agent"
                    elif function_doc.types == "Attach File to Document":
                        function_path = "hufai.ai.sdk_tools.handle_attach_file_to_document"
                    elif function_doc.types == "Speech to Text":
                        function_path = "hufai.ai.sdk_tools.handle_speech_to_text"
...
def create_function_tool(
	...
	"""
	Create a FunctionTool for HufAI Tool functions
...
def handle_run_agent(agent_name: str, prompt: str):
    ...
    try:
        ...
        job = enqueue(
            "hufai.ai.agent_integration.run_agent_sync",
            queue="default",
            timeout=300,
            is_async=True,
